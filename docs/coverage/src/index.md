...
# src
  ...
  var data = [{name: "source.c", path: "source.c", value: 1, type: "file", icon: "●●●●", itemStyle: { color: "#4cae4fdd", borderColor: "#4cae4f"}, label: { textBorderColor: "#4cae4f"}}]
...
<tbody>
<tr id="source.c" data-parent="">
<td style="text-align:left;" data-sort="b.source.c"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zm4 18H6V4h7v5h5z"/></svg></span> <a href="source.c/">source.c</a></td>
...
<tfoot>
<tr id="summary.src" data-parent="src">
